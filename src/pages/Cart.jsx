                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className='flex items-center'>
                    ...
                    <select onChange={e => updateCartItem(product._id, Number(e.target.value))} value={cartItems[product._id]} className='outline-none ml-1'>
                      {Array.from({ length: Math.max(9, cartItems[product._id]) }, (_, index) => (
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
          ...
          <div className="relative flex justify-between items-start mt-2">
            <p className="text-gray-500">{selectedAdress ? `${selectedAdress.street}, ${selectedAdress.city}, ${selectedAdress.country}, ${selectedAdress.state}` : "No address found"}</p>
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10">
                {addresses.map((address, index) => (
                  <p key={index} onClick={() => { setSelectedAdress(address); setShowAddress(false) }} className="text-gray-500 p-2 hover:bg-gray-100 cursor-pointer">
        ...
        <div className="text-gray-500 mt-4 space-y-2">
          ...
          <p className="flex justify-between text-lg font-medium mt-3">
            <span>Total Amount:</span><span>${(getCartAmount() + getCartAmount() * 2 / 100).toFixed(2)}</span>
          </p>
        </div>
