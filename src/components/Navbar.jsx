...
const Navbar = () => {
  ...
  return (
      <nav className="flex items-center justify-between px-6  lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all z-50">
            ...
            <NavLink to='/contact'>Contact</NavLink>
              ...
              : (
                <div className="relative group">
                  ...
                  <ul className="hidden group-hover:block border border-gray-200 shadow rounded-md text-sm z-40 absolute top-10 right-0 bg-white w-30 py-2.5 ">
